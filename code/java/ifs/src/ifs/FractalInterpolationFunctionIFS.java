 ...
 *
 */
public class FractalInterpolationFunctionIFS
{
    ...
    *
    */
   public FractalInterpolationFunctionIFS()
   {
   }
    ...
    *
    */
   public FractalInterpolationFunctionIFS( String name, int w, int h, int num )
   {
      _fileName           = name;
      _width              = w;
      _height             = h;
...
//          values.set( pos, y );
   ...
   protected void iterateSystem()
   {
      ...
      for( int i=0; i<_numberOfIterations; i++ )
      {
         ...
         nx = _a[ kk ] * x + _e[ kk ];
         ny = _c[ kk ] * x + _d[ kk ] * y + _h[ kk ] * z + _f[ kk ];
...
//       imageData[ (int)(imageData[0].length * ((double)40 / (double)_yMax)) ][ (int)(imageData.length * 0.6) ] = new HLSColorPoint( 360, 1, 1 );
   ...
   public static void main( String[] args )
   {
      ...
      FractalInterpolationFunctionIFS ifs = 
//          new FractalInterpolationFunctionIFS( "fif.tga", 4, 4, 1000000 );
         new FractalInterpolationFunctionIFS( "fif.tga", size, size, 1000000 );
