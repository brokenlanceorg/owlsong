   ...
   public void loadData( String[] words )
   {
      ...
      for( int i=0; i<words.length; i++ )
      {
         ...
         if( load && !"null".equals( words[ i ] ) )
         {
            ...
            {
               _tableModel.setValueAtLiteral( new String( words[ i ] ), r, 2 );
            }
            else if( pos % c == 3 )
            {
               _tableModel.setValueAtLiteral( new String( words[ i ] ), r, 3 );
            }
            else if( pos % c == 4 )
            {
               _tableModel.setValueAtLiteral( new String( words[ i ] ), r, 4 );
            }
            else if( pos % c == 5 )
            {
            ...
            {
               _tableModel.setValueAtLiteral( new BigDecimal( words[ i ] ), r, 6 );
            }
            else if( pos % c == 7 )
            {
               _tableModel.setValueAtLiteral( new BigDecimal( words[ i ] ), r, 7 );
            }
            else if( pos % c == 8 )
            {
               _tableModel.setValueAtLiteral( new BigDecimal( words[ i ] ), r, 8 );
            }
            else if( pos % c == 9 )
            {
               _tableModel.setValueAtLiteral( (new DateTime( words[ i ] )).toDate(), r, 9 );
            }
            else if( pos % c == 10 )
            {
               _tableModel.setValueAtLiteral( (new DateTime( words[ i ] )).toDate(), r, 10 );
            }
            else if( pos % c == 11 )
            {
               _tableModel.setValueAtLiteral( new BigDecimal( words[ i ] ), r, 11 );
            }
            else if( pos % c == 12 )
            {
               _tableModel.setValueAtLiteral( new Boolean( words[ i ] ), r, 12 );
            }
            else if( pos % c == 13 )
            {
               _tableModel.setValueAtLiteral( new Boolean( words[ i ] ), r++, 13 );
            }
         }
      }
   }
