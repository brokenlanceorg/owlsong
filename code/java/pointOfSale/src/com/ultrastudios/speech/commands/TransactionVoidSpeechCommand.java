 ...
 *
 */
public class TransactionVoidSpeechCommand implements SpeechCommand
{

   private TransactionTableModel _tableModel;
   private JTable                _table;
   private String                _columnName = "Void Amount";
   private String                _command    = "void";

   /**
    *
    */
   public TransactionVoidSpeechCommand()
   {
   }
    ...
    *
    */
   public TransactionVoidSpeechCommand( CommandDispatcher dispatch )
   {
//       dispatch.register( this );
    ...
    *
    */
   public TransactionVoidSpeechCommand( JTable table )
   {
      _table = table;
   ...
   public void handleCommand( String command )
   {
      ...
      {
         System.out.println( "TransactionVoidSpeechCommand will handle command: " + command );
