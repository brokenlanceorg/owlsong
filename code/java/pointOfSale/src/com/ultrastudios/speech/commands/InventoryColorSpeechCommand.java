 ...
 *
 */
public class InventoryColorSpeechCommand implements SpeechCommand
{

   private InventoryTableModel _tableModel;
   private JTable              _table;
   private String              _columnName = "color";
   private String              _command    = "color";

   /**
    *
    */
   public InventoryColorSpeechCommand()
   {
   }
    ...
    *
    */
   public InventoryColorSpeechCommand( CommandDispatcher dispatch )
   {
    ...
    *
    */
   public InventoryColorSpeechCommand( JTable table )
   {
      _table = table;
   ...
   public void handleCommand( String command )
   {
      ...
      {
         System.out.println( "InventoryColorSpeechCommand will handle command: " + command );
