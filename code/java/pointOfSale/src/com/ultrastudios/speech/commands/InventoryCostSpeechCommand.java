 ...
 *
 */
public class InventoryCostSpeechCommand implements SpeechCommand
{

   private InventoryTableModel _tableModel;
   private JTable              _table;
   private String              _columnName = "cost";
   private String              _command    = "cost";

   /**
    *
    */
   public InventoryCostSpeechCommand()
   {
   }
    ...
    *
    */
   public InventoryCostSpeechCommand( CommandDispatcher dispatch )
   {
//       dispatch.register( this );
    ...
    *
    */
   public InventoryCostSpeechCommand( JTable table )
   {
      _table = table;
   ...
   public void handleCommand( String command )
   {
      ...
      {
         System.out.println( "InventoryCostSpeechCommand will handle command: " + command );
