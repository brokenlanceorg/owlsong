 ...
 *
 */
public class InventoryTradeSpeechCommand implements SpeechCommand
{

   private InventoryTableModel _tableModel;
   private JTable              _table;
   private String              _columnName = "trade";
   private String              _command    = "trade";

   /**
    *
    */
   public InventoryTradeSpeechCommand()
   {
   }
    ...
    *
    */
   public InventoryTradeSpeechCommand( CommandDispatcher dispatch )
   {
//       dispatch.register( this );
    ...
    *
    */
   public InventoryTradeSpeechCommand( JTable table )
   {
      _table = table;
   ...
   public void handleCommand( String command )
   {
      ...
      {
         System.out.println( "InventoryTradeSpeechCommand will handle command: " + command );
