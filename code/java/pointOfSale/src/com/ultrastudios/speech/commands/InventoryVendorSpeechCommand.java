 ...
 *
 */
public class InventoryVendorSpeechCommand implements SpeechCommand
{

   private InventoryTableModel _tableModel;
   private JTable              _table;
   private String              _columnName = "vendor";
   private String              _command    = "vendor";

   /**
    *
    */
   public InventoryVendorSpeechCommand()
   {
   }
    ...
    *
    */
   public InventoryVendorSpeechCommand( CommandDispatcher dispatch )
   {
//       dispatch.register( this );
    ...
    *
    */
   public InventoryVendorSpeechCommand( JTable table )
   {
      _table = table;
   ...
   public void handleCommand( String command )
   {
      ...
      {
         System.out.println( "InventoryVendorSpeechCommand will handle command: " + command );
