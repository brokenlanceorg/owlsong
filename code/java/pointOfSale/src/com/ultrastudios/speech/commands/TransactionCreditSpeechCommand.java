 ...
 *
 */
public class TransactionCreditSpeechCommand implements SpeechCommand
{

   private TransactionTableModel _tableModel;
   private JTable                _table;
   private String                _columnName = "Credit Card Deposit";
   private String                _command    = "credit";

   /**
    *
    */
   public TransactionCreditSpeechCommand()
   {
   }
    ...
    *
    */
   public TransactionCreditSpeechCommand( CommandDispatcher dispatch )
   {
//       dispatch.register( this );
    ...
    *
    */
   public TransactionCreditSpeechCommand( JTable table )
   {
      _table = table;
   ...
   public void handleCommand( String command )
   {
      ...
      {
         System.out.println( "TransactionCreditSpeechCommand will handle command: " + command );
