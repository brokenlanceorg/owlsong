 ...
 * 
 */
public class SFIFIndividual extends Individual
{

   /**
    * Default constructor.
    */
   public SFIFIndividual()
   {
   }
   ...
   {
      Individual indy = new SFIFIndividual();
...
//       System.out.println( "In eval fitness..." );
      ...
      SimpleInterpolationFunctionIFS ifs = 
         new SimpleInterpolationFunctionIFS( null, target.length, target.length, 50000);
